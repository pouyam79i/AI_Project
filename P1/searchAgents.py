...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        "*** YOUR CODE HERE ***"
        # This list contains visited corners nodes
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        # (Starting Node, Empty Visited Corners)
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # Length of 4 means all corners are visited
...
def foodHeuristic(state, problem):
    ...
    for food in foodCoordinates:
        x, y = food
        if foodGrid[x][y]:
            temp_cost = mazeDistance((x, y), position, problem.startingGameState)
